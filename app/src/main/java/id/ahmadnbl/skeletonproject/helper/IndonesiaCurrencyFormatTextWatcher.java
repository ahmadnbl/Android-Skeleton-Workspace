...
/**
 * Created by billy on 10/5/16.
 *
 */

public class IndonesiaCurrencyFormatTextWatcher implements TextWatcher {
    ...
    public IndonesiaCurrencyFormatTextWatcher(EditText et)
    {
